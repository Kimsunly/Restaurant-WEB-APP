    ...
    <div class="hero_area">
        ...
        @php
            $fallbackSlides = collect([
                (object) [
                    ...
                    'subtitle' => 'Fresh flavors, quick service, and your favorites made right.',
                    'button_text' => 'Order Now',
                ],
                (object) [
                    'title' => 'Hot Pizza, Every Day',
                    'subtitle' => 'Try our signature pizzas baked with rich toppings and melty cheese.',
                    'button_text' => 'View Menu',
                ],
                (object) [
                    'title' => 'Burgers & Fries Combo',
                    'subtitle' => 'Juicy burgers paired with crispy fries for the perfect meal.',
                    'button_text' => 'Explore Deals',
                ],
            ]);

            $heroSlides = $slides->take(3)->values();

            if ($heroSlides->count() < 2) {
                // A single active slide looks static; use defaults so carousel behavior is visible.
                $heroSlides = $fallbackSlides;
            } elseif ($heroSlides->count() < 3) {
                $heroSlides = $heroSlides->concat($fallbackSlides->take(3 - $heroSlides->count()));
            }
        @endphp
        ...
        <section class="slider_section ">
            <div id="customCarousel1" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="row">
                                    <div class="col-md-7 col-lg-6 ">
                                        <div class="detail-box">
                                            ...
                                            <p>{{ $slide->subtitle }}</p>
                                            <div class="btn-box">
                                                <a href="{{ route('menu') }}" class="btn1">{{ $slide->button_text }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                @php
                    $indicatorCount = $heroSlides->count();
                @endphp
                    ...
                    <div class="container">
                        <ol class="carousel-indicators">
                            @for($i = 0; $i < $indicatorCount; $i++)
                                <li data-target="#customCarousel1" data-slide-to="{{ $i }}" class="{{ $i === 0 ? 'active' : '' }}">
                                </li>
                            @endfor
                        </ol>
                    </div>
